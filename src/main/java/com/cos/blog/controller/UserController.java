...
public class UserController {
	...
	public String kakaoCallback(String code) { // Data를 리턴해주는 컨트롤러 함수
		...
		System.out.println("블로그서버 패스워드 : " + kakaoProfile.getId());
		
		User kakaoUser = User.builder()
				.username(kakaoProfile.getKakao_account().getEmail().substring(0,kakaoProfile.getKakao_account().getEmail().indexOf("@")))
